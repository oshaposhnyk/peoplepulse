...
class EquipmentController extends Controller
{
     ...
     */
    public function maintenance(ScheduleMaintenanceRequest $request, string $equipmentId): JsonResponse
    {
        $this->equipmentService->scheduleMaintenance(
            $equipmentId,
            $request->description,
            $request->maintenanceType ?? 'Repair',
